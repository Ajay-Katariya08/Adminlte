                                            ...
                                            <div className="card-body">
                                                ...
                                                <div className="direct-chat-messages">
                                                    ...
                                                    <div className="direct-chat-msg">
                                                        ...
                                                        {/* /.direct-chat-infos */}
                                                        <img className="direct-chat-img" src={require("../img/user1-128x128.jpg")} alt="message user image" />
                                                        {/* /.direct-chat-img */}
                                                    ...
                                                    <div className="direct-chat-msg right">
                                                        ...
                                                        {/* /.direct-chat-infos */}
                                                        <img className="direct-chat-img" src={require("../img/user3-128x128.jpg")} alt="message user image" />
                                                        {/* /.direct-chat-img */}
                                                        <div className="direct-chat-text">
                                                ...
                                                <div className="direct-chat-contacts">
                                                    <ul className="contacts-list">
                                                        <li>
                                                            <a href="#">
                                                                <img className="contacts-list-img" src={require("../img/user1-128x128.jpg")} alt="User Avatar" />
